...
<section class="py-20 bg-primary-50">
    <div class="container mx-auto px-4 flex flex-col md:flex-row items-center gap-16">
        <div class="md:w-1/2">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Apotek Tanjung Sehat</h1>
            <p class="text-lg text-gray-600 mb-8">Apotek kami menyediakan obat-obatan lengkap, vitamin, dan alat kesehatan yang terjamin asli. Apoteker kami siap membantu memberikan informasi obat yang Anda butuhkan.</p>
            <div class="flex flex-col sm:flex-row gap-4">
                ...
                <a href="https://wa.me/<?= $wa_link ?>?text=Halo%20Apotek%20Tanjung%20Sehat,%20saya%20mau%20tanya%20obat" class="bg-primary-600 text-white px-8 py-4 rounded-full font-bold shadow-lg hover:bg-primary-700 transition-all flex items-center justify-center">
                    <i class="fab fa-whatsapp mr-2"></i> Tanya Obat
                </a>
            </div>
        </div>
        <div class="md:w-1/2">
            <img src="https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&q=80&w=1000" alt="Apotek Tanjung Sehat" class="rounded-3xl shadow-2xl">
        </div>
    </div>
</section>
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4">
        <h2 class="text-3xl font-bold text-center mb-16">Kenapa Pilih Apotek Kami?</h2>
