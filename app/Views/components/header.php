<header class="bg-white shadow-sm sticky top-0 z-40">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        <a href="<?= base_url() ?>" class="flex items-center space-x-2">
            <span class="text-2xl font-bold text-primary-600">Tanjung<span class="text-secondary-500">Sehat</span></span>
        </a>
        ...
        <nav class="hidden lg:flex space-x-6 font-medium">
            ...
            <a href="<?= base_url('pharmacy') ?>" class="hover:text-primary-600 transition-colors">Apotik</a>
        ...
        <a href="tel:<?= $settings['contact_phone'] ?? '' ?>" class="hidden xl:block bg-primary-600 text-white px-6 py-2 rounded-full font-semibold hover:bg-primary-700 transition-colors">
            Hubungi Kami
        </a>
    </div>
    ...
    <div id="mobile-menu" class="hidden lg:hidden bg-white border-t border-gray-100 px-4 py-4 space-y-4 shadow-xl">
        ...
        <a href="<?= base_url('pharmacy') ?>" class="block font-medium hover:text-primary-600">Apotik</a>
        ...
        <a href="tel:<?= $settings['contact_phone'] ?? '' ?>" class="block w-full text-center bg-primary-600 text-white py-3 rounded-xl font-bold">Hubungi Kami</a>
    </div>
</header>